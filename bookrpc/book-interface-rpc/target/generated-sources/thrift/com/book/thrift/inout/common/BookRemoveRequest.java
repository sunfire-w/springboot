...
public class BookRemoveRequest implements org.apache.thrift.TBase<BookRemoveRequest, BookRemoveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BookRemoveRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BookRemoveRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new BookRemoveRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BookRemoveRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BookRemoveRequest.class, metaDataMap);
  }

  public BookRemoveRequest() {
  }
   ...
   */
  public BookRemoveRequest(BookRemoveRequest other) {
  ...
  public BookRemoveRequest deepCopy() {
    return new BookRemoveRequest(this);
  }
   ...
   * 基础返回参数
   */
  public BookRemoveRequest setBaseReq(com.book.thrift.inout.common.BaseRequest baseReq) {
    this.baseReq = baseReq;
    return this;
  }
   ...
   *  
   */
  public BookRemoveRequest setBookModel(BookEntity BookModel) {
    this.BookModel = BookModel;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BookRemoveRequest)
      return this.equals((BookRemoveRequest)that);
    return false;
  }

  public boolean equals(BookRemoveRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BookRemoveRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BookRemoveRequest(");
    boolean first = true;
  ...
  private static class BookRemoveRequestStandardSchemeFactory implements SchemeFactory {
    public BookRemoveRequestStandardScheme getScheme() {
      return new BookRemoveRequestStandardScheme();
    }
  }

  private static class BookRemoveRequestStandardScheme extends StandardScheme<BookRemoveRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BookRemoveRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BookRemoveRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BookRemoveRequestTupleSchemeFactory implements SchemeFactory {
    public BookRemoveRequestTupleScheme getScheme() {
      return new BookRemoveRequestTupleScheme();
    }
  }

  private static class BookRemoveRequestTupleScheme extends TupleScheme<BookRemoveRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BookRemoveRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BookRemoveRequest struct) throws org.apache.thrift.TException {
