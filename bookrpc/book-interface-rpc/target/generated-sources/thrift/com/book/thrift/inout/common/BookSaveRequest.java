...
public class BookSaveRequest implements org.apache.thrift.TBase<BookSaveRequest, BookSaveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BookSaveRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BookSaveRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new BookSaveRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BookSaveRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BookSaveRequest.class, metaDataMap);
  }
   ...
   */
  public BookSaveRequest(BookSaveRequest other) {
  ...
  public BookSaveRequest deepCopy() {
   ...
   * 基础请求参数
   */
  public BookSaveRequest setBaseReq(com.book.thrift.inout.common.BaseRequest baseReq) {
    this.baseReq = baseReq;
    return this;
  }
   ...
   *  
   */
  public BookSaveRequest setBookModel(BookEntity BookModel) {
    this.BookModel = BookModel;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BookSaveRequest)
      return this.equals((BookSaveRequest)that);
    return false;
  }

  public boolean equals(BookSaveRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BookSaveRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BookSaveRequest(");
    boolean first = true;
  ...
  private static class BookSaveRequestStandardSchemeFactory implements SchemeFactory {
    public BookSaveRequestStandardScheme getScheme() {
      return new BookSaveRequestStandardScheme();
    }
  }

  private static class BookSaveRequestStandardScheme extends StandardScheme<BookSaveRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BookSaveRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BookSaveRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BookSaveRequestTupleSchemeFactory implements SchemeFactory {
    public BookSaveRequestTupleScheme getScheme() {
      return new BookSaveRequestTupleScheme();
    }
  }

  private static class BookSaveRequestTupleScheme extends TupleScheme<BookSaveRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BookSaveRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BookSaveRequest struct) throws org.apache.thrift.TException {
