...
public class BookUpdateRequest implements org.apache.thrift.TBase<BookUpdateRequest, BookUpdateRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BookUpdateRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BookUpdateRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new BookUpdateRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BookUpdateRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BookUpdateRequest.class, metaDataMap);
  }
   ...
   */
  public BookUpdateRequest(BookUpdateRequest other) {
  ...
  public BookUpdateRequest deepCopy() {
   ...
   * 基础请求参数
   */
  public BookUpdateRequest setBaseReq(com.book.thrift.inout.common.BaseRequest baseReq) {
    this.baseReq = baseReq;
    return this;
  }
   ...
   *  
   */
  public BookUpdateRequest setBookModel(BookEntity BookModel) {
    this.BookModel = BookModel;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BookUpdateRequest)
      return this.equals((BookUpdateRequest)that);
    return false;
  }

  public boolean equals(BookUpdateRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BookUpdateRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BookUpdateRequest(");
    boolean first = true;
  ...
  private static class BookUpdateRequestStandardSchemeFactory implements SchemeFactory {
    public BookUpdateRequestStandardScheme getScheme() {
      return new BookUpdateRequestStandardScheme();
    }
  }

  private static class BookUpdateRequestStandardScheme extends StandardScheme<BookUpdateRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BookUpdateRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BookUpdateRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BookUpdateRequestTupleSchemeFactory implements SchemeFactory {
    public BookUpdateRequestTupleScheme getScheme() {
      return new BookUpdateRequestTupleScheme();
    }
  }

  private static class BookUpdateRequestTupleScheme extends TupleScheme<BookUpdateRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BookUpdateRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BookUpdateRequest struct) throws org.apache.thrift.TException {
